...
// populated fields: an omitempty insertion emits nothing on its own, but an
// insertion at the wrong sequence position would still be byte-different
// because it would shift a neighbouring element. The golden string below was
// captured by marshalling this same EndDevice against the struct as it
// existed at origin/main before #177 (base e7ad354).
